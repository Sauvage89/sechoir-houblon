...
<details>
<summary>Table : lien evenement etage</summary>

## Table : lienEvenHoubEtag
...
<details>
<summary>Table : lien temperature etage</summary>

## Table : lienTempHoubEtag
...
| Champ			| Type		| Description							|
| --------------------- | ------------- | ------------------------------------------------------------- |
| id_houbVarr		| INT (PK)	| Identifiant unique de la variété				|
