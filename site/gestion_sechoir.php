<?php
// Appel au script qui interroge la BDD
...
<!-- ══ ÉTAT DU CYCLE ══ -->
<section class="mb-3">
<div class="section-title"><span class="section-num">00</span>État du cycle</div>
  ...
  <!-- ══ ÉTAGE 4 (haut) ══ -->
  <section class="mb-3">
    <div class="section-title"><span class="section-num">04</span>Étage 4 — Niveau haut</div>
    <div class="floor-card">
      <div class="row g-2">
        <div class="col-12 col-md-4"><div class="info-block">
  ...
  <!-- ══ ÉTAGE 3 ══ -->
  <section class="mb-3">
    <div class="section-title"><span class="section-num">03</span>Étage 3</div>
    <div class="floor-card">
      <div class="row g-2">
        <div class="col-12 col-md-4"><div class="info-block">
          <div class="info-label">🌿 Variété</div>
  ...
  <!-- ══ ÉTAGE 2 ══ -->
  <section class="mb-3">
    <div class="section-title"><span class="section-num">02</span>Étage 2</div>
    <div class="floor-card">
      <div class="row g-2">
        <div class="col-12 col-md-4"><div class="info-block">
          <div class="info-label">🌿 Variété</div>
  ...
  <section class="mb-3">
    <div class="section-title"><span class="section-num">01</span>Étage 1 — Niveau bas</div>
